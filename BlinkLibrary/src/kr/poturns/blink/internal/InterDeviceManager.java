...
public class InterDeviceManager extends BroadcastReceiver implements LeScanCallback {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (BluetoothAdapter.ACTION_STATE_CHANGED.equals(action)) {
			...
			if (onLog)
				Log.d("InterDeviceManager", " Address = " + deviceX.DeviceAddress  );
	...
	final IInternalOperationSupport.Stub mInternalOperationSupporter = new IInternalOperationSupport.Stub() {
		...
		@Override
		public BluetoothDeviceExtended[] obtainCurrentDiscoveryList() throws RemoteException {
			if (mAssistant != null)
		...
		@Override
		public void connectDevice(BluetoothDeviceExtended deviceX) throws RemoteException {
			// TODO Auto-generated method stub
			if (mAssistant != null)
		...
		@Override
		public void disconnectDevice(BluetoothDeviceExtended deviceX) throws RemoteException {
			// TODO Auto-generated method stub
			if (mAssistant != null)
		...
		@Override
		public BluetoothDeviceExtended[] obtainConnectedDeviceList() throws RemoteException {
			// TODO Auto-generated method stub
			return null;
		}

		@Override
		public void sendBlinkMessages(BluetoothDeviceExtended target, String jsonMsg) throws RemoteException {
