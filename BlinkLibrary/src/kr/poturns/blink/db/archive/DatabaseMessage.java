...
/**
 * 외부 디바이스에서 데이터를 검색할 때 보내는 메시지<br>
...
public class DatabaseMessage {
	...
	public static class Builder {
		...
		public Builder setCondition(String Condition) {
			if (Condition != null)
				mJsonObject.addProperty("Condition", Condition);
			return this;
		}

		public Builder setDateTimeFrom(String DateTimeFrom) {
			if (DateTimeFrom != null)
				mJsonObject.addProperty("DateTimeFrom", DateTimeFrom);
			return this;
		}

		public Builder setDateTimeTo(String DateTimeTo) {
			if (DateTimeTo != null)
				mJsonObject.addProperty("DateTimeTo", DateTimeTo);
			return this;
		}

		public Builder setContainType(int ContainType) {
			if (0 <= ContainType && ContainType <= 2)
				mJsonObject.addProperty("ContainType", ContainType);
			return this;
		}

		public Builder setData(String data) {
			if (data != null)
				mJsonObject.addProperty("data", data);
			return this;
		}
