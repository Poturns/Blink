...
public class JsonManager {
	...
	public static String obtainJsonSystemDatabaseObject(ArrayList<BlinkAppInfo> mSystemDatabaseObjectList){
		Gson gson = new GsonBuilder().setPrettyPrinting().create();
		String ret = gson.toJson(mSystemDatabaseObjectList);
		return ret;
	}
	public static ArrayList<BlinkAppInfo> obtainJsonSystemDatabaseObject(String json){
		Type SystemDatabaseObjectType = new TypeToken<ArrayList<BlinkAppInfo>>(){}.getType();
		ArrayList<BlinkAppInfo> ret = new Gson().fromJson(json, SystemDatabaseObjectType);
		return ret;
	}
