	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		IInternalEventCallback.Stub mIInternalEventCallback = new IInternalEventCallback.Stub() {
			...
			public void onReceiveData(int arg0, CallbackData arg1)
				...
				// Data 받음..
				final String data = arg1.InDeviceData == null ? arg1.OutDeviceData
						: (arg1.InDeviceData + arg1.OutDeviceData);
				//XXX 반드시 Ui Thread에서 호출되도록 변경 by MyungJin Kim
				runOnUiThread(new Runnable() {
					public void run() {
						...
						Toast.makeText(GlassActivity.this, data,
		...
		mInteraction = new BlinkServiceInteraction(this, null,
