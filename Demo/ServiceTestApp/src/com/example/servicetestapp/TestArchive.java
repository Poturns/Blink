...
//		exampleLogAll();
	...
	private void exampleRemoveMeasurementDatabase() {
		...
		int ret = mBlinkServiceManager.removeMeasurementData(Eye.class, null, null);
	...
	public void exampleObtainMeasurementDatabase(){
		...
		ArrayList<Eye> mEyeList = mBlinkServiceManager.obtainMeasurementData(Eye.class,new TypeToken<ArrayList<Eye>>(){}.getType());
		...
		ArrayList<Body> mBodyList = mBlinkServiceManager.obtainMeasurementData(Body.class,new TypeToken<ArrayList<Body>>(){}.getType());
		...
		ArrayList<Heart> mHeartList = mBlinkServiceManager.obtainMeasurementData(Heart.class,new TypeToken<ArrayList<Heart>>(){}.getType());
