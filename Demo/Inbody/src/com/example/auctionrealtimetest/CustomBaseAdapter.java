...
public class CustomBaseAdapter extends BaseAdapter {
	...
	private View.OnClickListener buttonClickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			 ...
			 * switch (v.getId()) {
			 * 
			 * // 이미지 클릭 case R.id.iv_image: Toast.makeText( mContext,
			 * "이미지 Tag = " + v.getTag(), Toast.LENGTH_SHORT ).show(); break;
			 * 
			 * // 버튼 클릭 case R.id.btn_button: Toast.makeText( mContext,
			 * "버튼 Tag = " + v.getTag(), Toast.LENGTH_SHORT ).show(); break;
			 * 
			 * // CheckBox case R.id.cb_box: Toast.makeText( mContext,
			 * "체크박스 Tag = " + v.getTag(), Toast.LENGTH_SHORT ).show(); break;
			 * 
			 * default: break; }
			 */
		}
